...
The **density** category has one intent but it affects **text** and **space** category scales.

- `density.maxDepth` describes the maximum depth for elements to appear within an experience.
